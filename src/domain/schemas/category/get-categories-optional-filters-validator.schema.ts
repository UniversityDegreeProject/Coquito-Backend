...
export const getCategoriesOptionalFiltersSchema = zod.object({
  search: zod.string()
  .trim()
  .optional(),

  status: zod.enum(["Activo", "Inactivo"], { error: "Estado inválido" })
  .optional(),
...
export type GetCategoriesOptionalFiltersSchema = zod.infer<typeof getCategoriesOptionalFiltersSchema>;