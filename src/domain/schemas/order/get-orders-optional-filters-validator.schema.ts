...
/**
 * Schema para obtener órdenes con filtros opcionales
 */
export const getOrdersOptionalFiltersSchema = paginationSchema.extend({
  // Filtros
...
export type GetOrdersOptionalFiltersSchema = zod.infer<typeof getOrdersOptionalFiltersSchema>;
