...
/**
 * Schema para obtener reporte de ventas
 * Mantiene las fechas como strings para evitar problemas de zona horaria
 */
export const getSalesReportSchema = zod.object({
...
export type GetSalesReportSchema = zod.infer<typeof getSalesReportSchema>;
