...
export const getUserOptionalFiltersSchema = zod.object({
  ...
  role: zod.enum(["Administrador", "Cajero"], { error: "Rol inválido" })
  .optional(),

  status: zod.enum(["Activo", "Inactivo", "Suspendido"], { error: "Estado inválido" })
  .optional(),
...
export type GetUserOptionalFiltersSchema = zod.infer< typeof getUserOptionalFiltersSchema>;